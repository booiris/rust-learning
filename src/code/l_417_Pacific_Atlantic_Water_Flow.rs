...
pub fn main() {
    println!(
        "res:{:?}",
        Solution::pacific_atlantic(to_2_vec([
            [1, 2, 2, 3, 5],
            [3, 2, 3, 4, 4],
            [2, 4, 5, 3, 1],
            [6, 7, 1, 4, 5],
        ...
        while let Some((x, y)) = start1.pop() {
            for dir in DIR {
                ...
                if nx < 0
                    ...
                    || nx >= n as i32
                    || ny >= m as i32
                    || key[nx as usize][ny as usize] & (1 << 0) != 0
                {
                    continue;
                }
        ...
        while let Some((x, y)) = start2.pop() {
            for dir in DIR {
                ...
                if nx < 0
                    ...
                    || nx >= n as i32
                    || ny >= m as i32
                    || key[nx as usize][ny as usize] & (1 << 1) != 0
                {
                    continue;
                }
                let (nx, ny) = (nx as usize, ny as usize);
